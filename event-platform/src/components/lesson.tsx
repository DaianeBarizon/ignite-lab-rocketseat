...
export function Lesson(props: LessonProps) {
  ...
  return (
    ...
    >
      ...
      <div className="rounded border border-gray-500 p-4 my-2 group-hover:border-green-500">
        <header className="flex items-center justify-between">
          ...
          <span className="text-xs text-white font-bold">
            <span
              className={
                isLessonAvailable
                  ? "rounded py-[0.125rem] px-2 border border-green-300"
                  : "rounded py-[0.125rem] px-2 border border-gray-300"
              }
            >
