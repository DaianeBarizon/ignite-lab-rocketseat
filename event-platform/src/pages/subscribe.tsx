...
export function Subscribe() {
  ...
  return (
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      <div className="bg-logo bg-no-repeat bg-top m-5">
        <div className="w-full max-w-[1100px] md:flex  items-center justify-between mt-20 mx-auto">
          ...
          <div className="p-8 bg-gray-700 border border-gray-500 rounded bg-opacity-80">
        ...
        <img src="/src/assets/image/background.png" className="mt-10" alt="background" />
      </div>
    </div>
  );
}
